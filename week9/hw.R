...
LOR5<-glm(Obesity~Physical_activity+Fat_meal+Drink+Sex+Education,data=df_logit,family=binomial)
summary(LOR5)
exp(coef(LOR5))
...
LOR6<-glm(Obesity~Physical_activity+Fat_meal+Drink+Sex,data=df_logit,family=binomial)
summary(LOR6)
exp(coef(LOR6))
